...
- [tech_demand_workua.png](diagrams/tech_demand_workua.png) — Overall technology mentions
- [junior_tech_demand_workua.png](diagrams/junior_tech_demand_workua.png) — Junior-level demand
- [middle_tech_demand_workua.png](diagrams/middle_tech_demand_workua.png) — Middle-level demand
- [senior_tech_demand_workua.png](diagrams/senior_tech_demand_workua.png) — Senior-level demand
